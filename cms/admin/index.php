                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        <?php
                            ...
                            $element_count=[$post_counts, $select_draft_post_count, $category_count, $users_count, $select_unapproved_sub_count, $comment_count, $select_unapproved_comment_count];
                            for($i=0; $i<7; $i++){
